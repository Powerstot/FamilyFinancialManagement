 ...
 *
 */
public class TotalPayMonthFrame extends JFrame {
		...
		btnTrue.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(!txtYear.getText().equals("") && !txtMonth.getText().equals("")) {
					int result = service.showMonthPay(txtYear.getText(),txtMonth.getText());
					JOptionPane.showMessageDialog(null,txtYear.getText()+"年"+txtMonth.getText()+"月支出："+result);
				}else {
